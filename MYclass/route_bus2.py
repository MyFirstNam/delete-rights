...
route2 = Blueprint("userroute2", __name__)
...
userroute2 = Flask(__name__)
@userroute2.route("/test/postx/endpointx", methods=['POST'])
def notifyAcc():
...
if __name__ == "__main__":
    ...
    # ip = "127.0.0.1"
    # port = 20001
    userroute2.register_blueprint(route2)
    userroute2.register_blueprint(confirm3)
    userroute2.run(host='127.0.0.1', port=20002, debug=True)