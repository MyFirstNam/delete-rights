...
route4 = Blueprint("userroute4", __name__)
...
userroute4 = Flask(__name__)
@userroute4.route("/test/postx/endpointx", methods=['POST'])
def notifyAcc():
...
if __name__ == "__main__":
    ...
    # ip = "127.0.0.1"
    # port = 20001
    userroute4.register_blueprint(route4)
    userroute4.register_blueprint(confirm3)
    userroute4.run(host='127.0.0.1', port=20004, debug=True)