    ...
    def process_task():
        ...
        async def delresponse(data):
            ...
            if response.status_code == 200:
                print_with_timestamp("notify:删除通知成功！")
            else:
                print_with_timestamp("notify:删除通知失败！")
            ...
            if node is not None:
                ...
                for _ in range(max_retries):
                    ...
                    if response.status_code == 200:
                        ...
                        print_with_timestamp(f"给'父节点'企业发送删除通知确认失败!")
                        print_with_timestamp("响应状态码: " + str(response.status_code))
                # 循环完仍未成功
                else:
