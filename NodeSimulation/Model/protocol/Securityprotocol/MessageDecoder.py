...
from NodeSimulation.Model.protocol.Securityprotocol.protocol_utils.hex_xor import hex_xor
from NodeSimulation.Model.protocol.Securityprotocol.protocol_utils.sm3_hmac import hmac
from NodeSimulation.Model.protocol.Securityprotocol.protocol_utils.pkcs5 import padPKCS7,unpadPKCS7
from NodeSimulation.Model.protocol.Securityprotocol.protocol_utils.gen_tree import gen_tree
...
if __name__ == '__main__':
    ...
    if True:
        ...
        # }
        data = {'affairs_id': '00001', 'user_id': 'u00001', 'info_id': 'a1b2c3d4e5',
                        'deleteMethod': 'yingjianshanchu',
                        'deleteGranularity': 'age'}
        ...
        pathformat = gen_tree_json(dataTransferPath, "b1000")
        ...
        def aaa(from_bus_id, to_bus_id, time_stamp, plaintext, segment_tree):
            ...
            print(to_bus_id, "解密出的：")
            for i in next_segment_tree_list:
                print(i)

            for i, j in zip(next_bus_ip_list, next_segment_tree_list):
                j = j.to_json(sort=False)
                j = json2tree(j)
